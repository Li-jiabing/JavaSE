...
//        hotel.print();
        ...
        System.out.println("功能编号对应的功能：[1]查看房间列表 。[2]表示订房。[3]表示退房。[0]表示退出系统");
        ...
        int i = scanner.nextInt();
            if (i == 1) {
                ...
                //订房
                System.out.println("请输入您要订的房间编号");
                Scanner scanner1 = new Scanner(System.in);
                int roomNo = scanner1.nextInt();
                if (hotel.search(roomNo)){
                    hotel.order(roomNo);
                }else{
                    System.out.println("对不起，您输入的房间已经被预订，请重新输入功能编号");
                }
            } else if (i == 3) {
                //退房
                ...
                if (!(hotel.search(roomNo))){
                    ...
                    System.out.println("对不起，您输入的房间未入住，请重新输入功能编号");
                }
            } else if (i == 0) {
                //退出系统
